...
resultD.addEventListener("click", function() {
    ...
    function encodeClick() {
        ...
        document.getElementById('resultLabel1').innerHTML = 'Encrypted Ciphertext (<span style="color: black;">1st Level</span>):';
    ...
    function decodeClick() {
        if (!checkText() || !checkKey())
            return;
        var output = document.getElementById('resultText1');
        document.getElementById('resultLabel1').innerHTML = 'Decrypted Ciphertext (<span style="color: black;">1st Level</span>):';
    ...
    function generateLevel1Grid(key, columns1, columnorder) {
        ...
        for (var i = 0; i < key.length; i++) {
            ...
            textColor = (textColor === 'black') ? 'blue' : 'black';
        }
        grid1 += '\t\t\r\n';
  ...
  function changeContentTwo() {
        ...
        document.getElementById('resultLabel1').innerHTML = 'Encrypted Ciphertext (<span style="color: black;">1st Level</span>):';
        document.getElementById('resultLabel1').style.display = 'block';
        document.getElementById('resultLabel2').innerHTML = 'Encrypted Ciphertext (<span style="color: black;">2nd Level</span>):';
        ...
        document.getElementById('resultLabel1').innerHTML = 'Decrypted Ciphertext (<span style="color: black;">1st Level</span>):';
        document.getElementById('resultLabel1').style.display = 'block';
        document.getElementById('resultLabel2').innerHTML = 'Decrypted Ciphertext (<span style="color: black;">2nd Level</span>):';
        document.getElementById('resultLabel2').style.display = 'block';
        document.getElementById('resultLabel3').style.display = 'none';
        scrollTo('result');
        }
  ...
  function changeContentThree() {
        ...
        document.getElementById('resultLabel2').innerHTML = 'Encrypted Ciphertext (<span style="color: black;">2nd Level</span>):';
        document.getElementById('resultLabel2').style.display = 'block';
        document.getElementById('resultLabel3').innerHTML = 'Encrypted Ciphertext (<span style="color: black;">3rd Level</span>):';
        ...
        document.getElementById('resultLabel2').innerHTML = 'Decrypted Ciphertext (<span style="color: black;">2nd Level</span>):';
        document.getElementById('resultLabel2').style.display = 'block';
        document.getElementById('resultLabel3').innerHTML = 'Decrypted Ciphertext (<span style="color: black;">3rd Level</span>):';
        document.getElementById('resultLabel3').style.display = 'block';
        scrollTo('result');
        }
    }
